...
| [`Public-Data-Set.json`](Public-Data-Set.json) | A public dataset — inline or referenced by URL with checksum integrity. | [Policy & rule registries](../docs/use-cases.md#4-policy--rule-registries) |
